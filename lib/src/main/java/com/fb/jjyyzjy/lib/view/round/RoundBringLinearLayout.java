...
import com.fb.jjyyzjy.lib.view.bring.BringToFrontLinearLayout;

/**
 * Created by JJYYZJY on 2017/4/21.
 */
public class RoundBringLinearLayout extends BringToFrontLinearLayout {
    public RoundBringLinearLayout(Context context) {
        this(context,null);
    }

    public RoundBringLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public RoundBringLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
